-- Folkets meninger: authors must share at least 3 For/Imot bullet points.

ALTER TABLE public.citizen_opinions
  ADD COLUMN IF NOT EXISTS points jsonb NOT NULL DEFAULT '[]'::jsonb;

COMMENT ON COLUMN public.citizen_opinions.points IS
  'Author For/Imot bullet points shown with the opinion. create_citizen_opinion requires at least 3, including both stances.';
