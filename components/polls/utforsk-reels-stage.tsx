...
export function ReelsEntryCta({
  ...
  return (
    <button
      ...
      onClick={onOpen}
      aria-controls="reels"
      className="flex w-full items-center justify-between gap-4 rounded-2xl border border-brand/20 bg-brand/5 px-5 py-4 text-left transition-colors hover:border-brand/40 hover:bg-brand/10"
    >
