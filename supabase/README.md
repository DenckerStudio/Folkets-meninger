...
| User onboarding | `20260819140000_user_onboarding.sql` | `users.onboarding_completed_at`, `onboarding_skipped`, `onboarding_tour_completed_at`, `set_user_onboarding_state` |
