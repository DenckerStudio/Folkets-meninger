...
| User onboarding | `20260819140000_user_onboarding.sql` | `users.onboarding_completed_at`, `onboarding_skipped` (legacy; wizard skip is no longer accepted), `onboarding_tour_completed_at`, `set_user_onboarding_state` |
